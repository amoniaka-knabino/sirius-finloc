...
{
    /// <summary>
    /// Подробная информация о банковском продукте
    /// </summary>
    [DataContract]
        public partial class ProductsResponse :  IEquatable<ProductsResponse>, IValidatableObject
    {
        ...
        public ProductsResponse(ProductsResponseData data = default(ProductsResponseData), Links links = default(Links), Meta meta = default(Meta))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for ProductsResponse and cannot be null");
            }
            else
            {
                this.Data = data;
