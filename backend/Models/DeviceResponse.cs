...
{
    /// <summary>
    /// Полезная нагрузка ответа запроса об устройствах
    /// </summary>
    [DataContract]
        public partial class DeviceResponse :  IEquatable<DeviceResponse>, IValidatableObject
    {
        ...
        public DeviceResponse(DataDeviceResponse data = default(DataDeviceResponse), Links links = default(Links), Meta meta = default(Meta))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for DeviceResponse and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        public DataDeviceResponse Data { get; set; }
