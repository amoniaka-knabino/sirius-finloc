...
namespace IO.Swagger.Model
{
        ...
        public partial class Service :  IEquatable<Service>, IValidatableObject
    {
        ...
        /// <param name="serviceName">Дополнительная информация в свободной форме.</param>
        public Service(DeviceServiceTypeCode serviceType = default(DeviceServiceTypeCode), string serviceName = default(string))
        {
        ...
        public DeviceServiceTypeCode ServiceType { get; set; }
