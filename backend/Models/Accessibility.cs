...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Accessibility :  IEquatable<Accessibility>, IValidatableObject
    {
        /// <summary>
        ...
        public Accessibility(AccessibilityCode type = default(AccessibilityCode), string description = default(string))
        {
            this.Type = type;
        ...
        public AccessibilityCode Type { get; set; }
        ...
        {
            return this.Equals(input as Accessibility);
        }

        /// <summary>
        /// Returns true if Accessibility instances are equal
        /// </summary>
        /// <param name="input">Instance of Accessibility to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Accessibility input)
        {
            if (input == null)
                return false;
