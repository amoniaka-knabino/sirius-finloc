...
{
    /// <summary>
    /// Полезная нагрузка ответа информации о списке кредитных организаций
    /// </summary>
    [DataContract]
        public partial class BankResponse :  IEquatable<BankResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public BankResponse(DataBankResponse data = default(DataBankResponse), Links links = default(Links), Meta meta = default(Meta))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for BankResponse and cannot be null");
            }
            else
            {
                this.Data = data;
        ...
        public DataBankResponse Data { get; set; }
